...
def generate_captions(sess,video_paths,model_path,infer_util,max_iter,max_len,batch_size,beam_size):
    gen_caption = []    
    ...
    with tf.Graph().as_default(): #so that the whole program doesn't get polluted
        ...
        with tf.Session() as sess:
            for model_path in model_paths:
                gen_captions.append(generate_captions(sess,video_paths,model_path,infer_util,max_iter,max_len,batch_size,FLAGS.beam_size))
