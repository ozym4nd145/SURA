...
class Caption_Model(object):
    ...
    def build_embeddings(self):
        ...
        with tf.variable_scope("rnn_units"):
            self.cell_1 = tf.contrib.rnn.BasicLSTMCell(self.hidden_size_lstm,reuse=tf.get_variable_scope().reuse)
            self.cell_2 = tf.contrib.rnn.BasicLSTMCell(self.hidden_size_lstm,reuse=tf.get_variable_scope().reuse)
