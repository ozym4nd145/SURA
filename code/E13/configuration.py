...
class ModelConfig(object):
    def __init__(self,data_gen):
        ...
        self.config["hidden_size_lstm"] = 1000
        self.config["num_lstm_layer"] = 2
        self.config["vocab_size"] = data_gen.vocab_size
        self.config["initializer_scale"] = 0.1
        self.config["learning_rate"] = 1e-4
        self.config["rnn1_input_keep_prob"] = 0.5
        self.config["rnn1_output_keep_prob"] = 0.5
        self.config["rnn2_input_keep_prob"] = 0.5
        self.config["rnn2_output_keep_prob"] = 0.5
