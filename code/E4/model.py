...
class Model_S2VT(object):
    ...
    def build_inception_output(self):
        self.inception_output_raw = inception_base.get_base_model(self.processed_video_feed)
        self.inception_output = tf.reshape(self.inception_output_raw,[-1,self.num_frames,self.num_last_layer_units])
