...
def generate_captions(sess,model,video_path,inception_checkpoint,
                        num_frames_per_clip,num_frames_per_sec,max_cap_len,batch_size):
    video = cv2.VideoCapture(sess,model,video_path)
    ...
    num_batches = int((num_frames_to_read+num_frames_per_clip-1)/num_frames_per_clip)
...
def main():
    ...
    captions = generate_captions(sess,model,video_path,inception_checkpoint,
                                num_frames_per_clip,num_frames_per_sec,max_cap_len,batch_size)
